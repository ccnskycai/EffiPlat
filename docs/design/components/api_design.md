      ...
      ```json
      {
        ...
        "data": {
          ...
          "assignedResponsibilities": [
            {
              "responsibilityId": 1,
              "responsibilityName": "Database Administrator",
              "isPrimary": true
            },
            {
              "responsibilityId": 5,
              "responsibilityName": "Service Owner - Auth",
              "isPrimary": false
            }
          ]
        }
          ...
          "items": [
            {
              "id": 1,
              "name": "manage_user",
              "description": "Allows creating, updating, deleting users"
            },
            {
              "id": 2,
              "name": "view_user",
        ...
        "data": {
          ...
          "history": [
            ...
            },
            {
              ...
              "to": { "groupId": 11, "name": "Backend Team" }
            }
          ]
        }
      }
