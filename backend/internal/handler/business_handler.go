...
// @Success 201 {object} model.SuccessResponse{data=service.BusinessOutputDTO} "Business created successfully"
// @Failure 400 {object} model.ErrorResponse "Invalid request payload or validation error"
// @Failure 409 {object} model.ErrorResponse "Business with this name already exists"
...
// @Success 200 {object} model.SuccessResponse{data=service.BusinessOutputDTO} "Business details"
// @Failure 400 {object} model.ErrorResponse "Invalid business ID format"
// @Failure 404 {object} model.ErrorResponse "Business not found"
// @Failure 500 {object} model.ErrorResponse "Internal server error"
...
// @Success 200 {object} model.PaginatedResponse{data=[]service.BusinessOutputDTO} "List of businesses"
...
// @Success 200 {object} model.SuccessResponse{data=service.BusinessOutputDTO} "Business updated successfully"
// @Failure 400 {object} model.ErrorResponse "Invalid business ID format or request payload"
// @Failure 404 {object} model.ErrorResponse "Business not found"
// @Failure 409 {object} model.ErrorResponse "Another business with the new name already exists"
// @Failure 500 {object} model.ErrorResponse "Internal server error"
...
// @Produce json
// @Param businessId path int true "Business ID"
// @Success 204 {object} model.SuccessResponse "Business deleted successfully"
// @Failure 400 {object} model.ErrorResponse "Invalid business ID format"
// @Failure 404 {object} model.ErrorResponse "Business not found"
// @Failure 500 {object} model.ErrorResponse "Internal server error"
