...
func (r *gormServiceTypeRepository) Create(ctx context.Context, serviceType *models.ServiceType) error {
	return r.db.WithContext(ctx).Create(serviceType).Error
}

// GetByID retrieves a service type by its ID.
func (r *gormServiceTypeRepository) GetByID(ctx context.Context, id uint) (*models.ServiceType, error) {
	var serviceType models.ServiceType
	err := r.db.WithContext(ctx).First(&serviceType, id).Error
	if err != nil {
		if errors.Is(err, gorm.ErrRecordNotFound) {
			return nil, models.ErrServiceTypeNotFound
		}
		return nil, err
	}
...
func (r *gormServiceTypeRepository) GetByName(ctx context.Context, name string) (*models.ServiceType, error) {
	var serviceType models.ServiceType
...
func (r *gormServiceTypeRepository) List(ctx context.Context, params models.ServiceTypeListParams) ([]models.ServiceType, int64, error) {
	var serviceTypes []models.ServiceType
	var totalCount int64

	query := r.db.WithContext(ctx).Model(&models.ServiceType{})
...
func (r *gormServiceTypeRepository) Update(ctx context.Context, serviceType *models.ServiceType) error {
...
func (r *gormServiceTypeRepository) Delete(ctx context.Context, id uint) error {
	return r.db.WithContext(ctx).Delete(&models.ServiceType{}, id).Error
}
...
func (r *gormServiceTypeRepository) CheckExists(ctx context.Context, id uint) (bool, error) {
	var count int64
	err := r.db.WithContext(ctx).Model(&models.ServiceType{}).Where("id = ?", id).Count(&count).Error
	if err != nil {
		return false, err
	}
	return count > 0, nil
