...
func (r *gormResponsibilityGroupRepository) Create(ctx context.Context, group *models.ResponsibilityGroup, responsibilityIDs []uint) (*models.ResponsibilityGroup, error) {
	...
	err := r.db.WithContext(ctx).Transaction(func(tx *gorm.DB) error {
		...
		if len(responsibilityIDs) > 0 {
			var responsibilitiesToAssociate []models.Responsibility
			for _, respID := range responsibilityIDs {
				...
				responsibilitiesToAssociate = append(responsibilitiesToAssociate, models.Responsibility{ID: respID})
			}
...
func (r *gormResponsibilityGroupRepository) List(ctx context.Context, params models.ResponsibilityGroupListParams) ([]models.ResponsibilityGroup, int64, error) {
	var groups []models.ResponsibilityGroup
	var total int64
	query := r.db.WithContext(ctx).Model(&models.ResponsibilityGroup{})
...
func (r *gormResponsibilityGroupRepository) GetByID(ctx context.Context, id uint) (*models.ResponsibilityGroup, error) {
	r.logger.Debug("GORM: Getting responsibility group by ID", zap.Uint("id", id))
	var group models.ResponsibilityGroup
...
func (r *gormResponsibilityGroupRepository) Update(ctx context.Context, group *models.ResponsibilityGroup, responsibilityIDs *[]uint) (*models.ResponsibilityGroup, error) {
	...
	err := r.db.WithContext(ctx).Transaction(func(tx *gorm.DB) error {
		...
		var existingGroup models.ResponsibilityGroup
		...
		*group = existingGroup // Reflect updates back to the input `group` pointer for consistency
		...
		if responsibilityIDs != nil {
			...
			if len(idsToAssociate) > 0 {
				var newResponsibilities []models.Responsibility
				for _, respID := range idsToAssociate {
					newResponsibilities = append(newResponsibilities, models.Responsibility{ID: respID})
				}
...
func (r *gormResponsibilityGroupRepository) Delete(ctx context.Context, id uint) error {
	...
	return r.db.WithContext(ctx).Transaction(func(tx *gorm.DB) error {
		...
		if err := tx.Delete(&models.ResponsibilityGroup{}, id).Error; err != nil {
...
func (r *gormResponsibilityGroupRepository) AddResponsibilityToGroup(ctx context.Context, groupID uint, responsibilityID uint) error {
	...
	association := models.ResponsibilityGroupResponsibility{
...
func (r *gormResponsibilityGroupRepository) RemoveResponsibilityFromGroup(ctx context.Context, groupID uint, responsibilityID uint) error {
	...
	result := r.db.WithContext(ctx).Where("responsibility_group_id = ? AND responsibility_id = ?", groupID, responsibilityID).Delete(&models.ResponsibilityGroupResponsibility{})
...
func (r *gormResponsibilityGroupRepository) GetResponsibilitiesForGroup(ctx context.Context, groupID uint) ([]models.Responsibility, error) {
