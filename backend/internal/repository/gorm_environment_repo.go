...
func (r *gormEnvironmentRepository) Create(ctx context.Context, env *models.Environment) (*models.Environment, error) {
...
func (r *gormEnvironmentRepository) List(ctx context.Context, params models.EnvironmentListParams) ([]models.Environment, int64, error) {
	r.logger.Debug("GORM: Listing environments", zap.Any("params", params))
	var environments []models.Environment
	var total int64

	tx := r.db.WithContext(ctx).Model(&models.Environment{})
...
func (r *gormEnvironmentRepository) GetByID(ctx context.Context, id uint) (*models.Environment, error) {
...
func (r *gormEnvironmentRepository) GetBySlug(ctx context.Context, slug string) (*models.Environment, error) {
...
func (r *gormEnvironmentRepository) Delete(ctx context.Context, id uint) error {
	...
	result := r.db.WithContext(ctx).Delete(&models.Environment{}, id)
	if result.Error != nil {
