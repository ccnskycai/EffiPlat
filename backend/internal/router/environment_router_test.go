...
func TestCreateEnvironment(t *testing.T) {
	...
	t.Run("Failure_DuplicateSlug", func(t *testing.T) {
		...
		firstCreateReq := models.CreateEnvironmentRequest{
		...
		secondCreateReq := models.CreateEnvironmentRequest{
			Name:        "Another Name",
...
func TestGetEnvironments(t *testing.T) {
	...
	createEnv := func(name, slug string) models.EnvironmentResponse {
		createReq := models.CreateEnvironmentRequest{Name: name, Description: name + " desc", Slug: slug}
		payload, _ := json.Marshal(createReq)
		req, _ := http.NewRequest(http.MethodPost, "/api/v1/environments", bytes.NewBuffer(payload))
		req.Header.Set("Content-Type", "application/json")
		req.Header.Set("Authorization", "Bearer "+token)
	...
	t.Run("Success_DefaultPagination", func(t *testing.T) {
		...
		var listResp struct {
			...
			Message string `json:"message"`
			Data    struct {
				Items      []models.EnvironmentResponse `json:"items"`
...
func TestGetEnvironmentByID(t *testing.T) {
	...
	createReq := models.CreateEnvironmentRequest{Name: "GetByID Test", Slug: "get-by-id-test"}
	payload, _ := json.Marshal(createReq)
...
func TestGetEnvironmentBySlug(t *testing.T) {
	...
	// Create an environment to fetch
	createReq := models.CreateEnvironmentRequest{Name: "GetBySlug Test", Slug: "get-by-slug-test"}
	payload, _ := json.Marshal(createReq)
	reqCreate, _ := http.NewRequest(http.MethodPost, "/api/v1/environments", bytes.NewBuffer(payload))
	reqCreate.Header.Set("Content-Type", "application/json")
	reqCreate.Header.Set("Authorization", "Bearer "+token)
...
func TestUpdateEnvironment(t *testing.T) {
	...
	createInitialEnv := func(name, slug string) models.EnvironmentResponse {
		createReq := models.CreateEnvironmentRequest{Name: name, Description: name + " initial desc", Slug: slug}
		payload, _ := json.Marshal(createReq)
		req, _ := http.NewRequest(http.MethodPost, "/api/v1/environments", bytes.NewBuffer(payload))
		req.Header.Set("Content-Type", "application/json")
		req.Header.Set("Authorization", "Bearer "+token)
	...
	t.Run("Success_UpdateNameAndDescription", func(t *testing.T) {
		updateReq := models.UpdateEnvironmentRequest{
			Name:        models.StringPtr("Updated Name"),
	...
	t.Run("Success_UpdateSlug", func(t *testing.T) {
		...
		updateReq := models.UpdateEnvironmentRequest{
			Slug: models.StringPtr("slug-update-new"),
		}
		payload, _ := json.Marshal(updateReq)
	...
	t.Run("Failure_UpdateToExistingSlug", func(t *testing.T) {
		updateReq := models.UpdateEnvironmentRequest{
			Slug: models.StringPtr(conflictingEnv.Slug), // Try to update to conflictingEnv's slug
		}
		payload, _ := json.Marshal(updateReq)
	...
	t.Run("Failure_UpdateToExistingName", func(t *testing.T) {
		updateReq := models.UpdateEnvironmentRequest{
			Name: models.StringPtr(conflictingEnv.Name), // Try to update to conflictingEnv's name
		}
		payload, _ := json.Marshal(updateReq)
		// Use initialEnv's ID for the update attempt
		req, _ := http.NewRequest(http.MethodPut, fmt.Sprintf("/api/v1/environments/%d", initialEnv.ID), bytes.NewBuffer(payload))
	...
	t.Run("Failure_NotFound", func(t *testing.T) {
		nonExistentID := 99999
		updateReq := models.UpdateEnvironmentRequest{Name: models.StringPtr("No Matter Name")}
		payload, _ := json.Marshal(updateReq)
	...
	t.Run("Failure_InvalidPayload", func(t *testing.T) {
		...
		shortName := "a"
		updateReq := models.UpdateEnvironmentRequest{Name: &shortName}
		payload, _ := json.Marshal(updateReq)
		req, _ := http.NewRequest(http.MethodPut, fmt.Sprintf("/api/v1/environments/%d", initialEnv.ID), bytes.NewBuffer(payload))
		req.Header.Set("Content-Type", "application/json")
		req.Header.Set("Authorization", "Bearer "+token)
...
func TestDeleteEnvironment(t *testing.T) {
	...
	createEnvForDelete := func(name, slug string) models.EnvironmentResponse {
		createReq := models.CreateEnvironmentRequest{Name: name, Description: name + " desc", Slug: slug}
		payload, _ := json.Marshal(createReq)
		req, _ := http.NewRequest(http.MethodPost, "/api/v1/environments", bytes.NewBuffer(payload))
		req.Header.Set("Content-Type", "application/json")
