...
func createTestResponsibilityGroup(t *testing.T, router http.Handler, token string, groupReq handler.CreateResponsibilityGroupRequest) models.ResponsibilityGroup {
	...
	var createdGroupResp struct {
		Data models.ResponsibilityGroup `json:"data"`
	}
...
func TestResponsibilityGroupRoutes(t *testing.T) {
	...
	resp1 := router.CreateTestResponsibility(t, app.Router, token, &models.Responsibility{Name: "Group Test Resp 1", Description: "Desc for group test 1"})
	resp2 := router.CreateTestResponsibility(t, app.Router, token, &models.Responsibility{Name: "Group Test Resp 2", Description: "Desc for group test 2"})
	resp3 := router.CreateTestResponsibility(t, app.Router, token, &models.Responsibility{Name: "Group Test Resp 3", Description: "Desc for group test 3"})
